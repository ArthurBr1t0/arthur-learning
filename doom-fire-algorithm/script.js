...
function start() {
	...
	// retorna os comandos dentro das chaves
}
...
function createFireDataStructure() {
	...
	// criação da base do fogo, cria os pixels com base no array "firePixelsArray"
}
...
function calculateFirePropagation() {
	...
	// calculo da propagação do fogo, com base no eixo "x" (width) e "y" (height)
}
...
function updateFireInstensityPerPixel(currentPixelIndex) {
	...
	// calcula a intensidade por pixel do fogo, pegando de forma randomizada, preenchendo cada espaço da "tabela"
}
...
function renderFire() {
	...
	// renderiza o fogo na tela, para cada "pixel"
}
